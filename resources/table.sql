...
CREATE TABLE `financial _report` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '物理主键',
  `stock_code` varchar(32) CHARACTER SET latin1 DEFAULT NULL COMMENT '股票代码',
  `stock_name` varchar(32) CHARACTER SET latin1 DEFAULT NULL COMMENT '股票名称',
  `report_peroid` varchar(12) CHARACTER SET latin1 DEFAULT NULL COMMENT '报告期,yyyy-MM-dd',
  ...
  `crash_report` json DEFAULT NULL COMMENT '现金流量表',
